...
ava_1["default"]('extractJson() throws error for invalid bundle.', function (t) {
    t.is(t.throws(function () { return src_1.extractJson([]); }, { instanceOf: Error }).message, src_1.errors.INVALID_BUNDLE, 'extractJson() should throw correct error for invalid bundle.');
});
ava_1["default"]('extractJson() throws error for invalid JSON.', function (t) {
    t.is(t.throws(function () { return src_1.extractJson(samples_1.bundleWithInvalidJSON); }, { instanceOf: Error }).message, src_1.errors.INVALID_JSON, 'extractJson() should throw correct error for invalid JSON.');
});
